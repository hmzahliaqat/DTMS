...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static"  data-menu="horizontal-menu" >
    ...
    {{-- <div class="horizontal-menu-wrapper">
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                @hasrole(['students'])
                    <li    aria-expanded="false" aria-controls="collapseExample"  class="dropdown nav-item" data-menu="dropdown"><a   id="addStudentBtn" class="dropdown-toggle nav-link d-flex align-items-center" ><i data-feather="user"></i><span>Available</span></a>
                    </li>
                        @endhasrole
    ...
    <hr class="" style="padding-bottom: 50px;"/>

    @hasrole(['student'])

   <stuhome-component></stuhome-component>
    @endrole
...
.sidebar {
    ...
    padding: 20px;
    overflow-y: auto;
    border-left: 1px solid #dee2e6; /* Light border color */
    box-shadow: -2px 0px 5px rgba(0, 0, 0, 0.1); /* Add a subtle shadow */
    z-index: 999;
}

.course-item {
    background-color: #fff; /* White background color for each course item */
    padding: 10px;
    border-radius: 5px;
